...
faqs:
  - question: "Can neon tetras go in a 30 litre tank?"
    answer: "Not properly. Neons need a minimum of 60 litres to school the way they should. Six fit in 30 litres, but they will not show the natural shoaling behaviour and the bioload sits on the edge. A smaller schooling species is the better choice."
  ...
  - question: "Is it possible to mix two species of nano fish in 30 litres?"
    answer: "Generally no. 30 litres has one school slot. Adding a second species means both schools end up too small (typically four to five fish each) to display natural behaviour. The exception is a bottom species like three pygmy corydoras alongside a top-water school, but the trade-off is reduced swimming volume."
  ...
  - question: "Is CO2 required for a 30 litre planted tank?"
    answer: "No. The plant list in this article (Java Moss, Anubias, Cryptocoryne Wendtii) thrives without CO2 injection. A faster-growing or red-stem-heavy scape later may benefit from a small pressurised CO2 system, but it is not required to start."
---
...
In all four cases, dense moss cover means the colony grows steadily. See [can neon tetras live with cherry shrimp](/guides/can-neon-tetras-live-with-cherry-shrimp) for the moss-coverage detail. A starter colony of 10 to 15 shrimp becomes 30+ in six months if the parameters are right.
...
The [planner tool](/planner) takes a tank volume of 30 litres and surfaces stocking density warnings plus every species in the catalogue that fits. The [compatibility tool](/compatibility?anchor=fish:ember-tetra) anchored to any of the four picks above shows plant, shrimp, and moss matches.
