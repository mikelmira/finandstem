export const legal = {
  privacy: {
    ...
    sections: [
      ...
      {
        heading: "Your rights",
        body: "You can request access to, correction of, or deletion of any data we hold by emailing finandstem@gmail.com, we process requests within 14 days. POPIA (South Africa) and GDPR (EU) rights apply where you live.",
      },
      {
        heading: "Cookies",
      ...
      {
        heading: "Contact",
        body: "Privacy questions go to finandstem@gmail.com.",
      },
    ],
  },
  terms: {
