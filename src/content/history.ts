  ...
  chapters: [
    ...
    },
    {
      ...
      body: [
        ...
        "The species had been formally described by the American zoologist William Stimpson in 1860 as Caridina multidentata, but for most of the 20th century aquarists knew it by the synonym Caridina japonica. A 2006 study by Cai, Ng, Shokita, and Satake resolved the taxonomy and the older Stimpson name was restored as the valid one. The common name \"Amano shrimp\" was adopted by English-speaking aquarists in the early 1990s in recognition of Amano's role in popularising the species. It remains the standard common name today.",
