...
export const snails: ReadonlyArray<SnailEntry> = [
  ...
  },
  {
    ...
    family: "Physidae",
    origin: "Cosmopolitan, widely introduced worldwide",
    adultSize: "1–1.5",
    minTankSize: "5",
    diet: "Detritivore / algae grazer",
    feedingNotes:
      "Lives entirely on tank waste: detritus, decaying leaves, leftover food, biofilm and soft algae. Needs no feeding. Numbers simply track how much surplus food is around.",
    tempRange: "15–30",
    phRange: "7.0–8.0",
    dghRange: "6–18",
    khRange: "3–12",
    ...
    lifespan: "1",
    breeding:
      "Hermaphroditic and prolific, a single snail can seed a whole tank. Lays clear jelly egg blobs on glass and leaves. Populations explode with overfeeding and shrink when food is scarce.",
    algaeEaterRating: 2,
    plantSafe: "Yes",
    fishTankSafeWith: "Anything peaceful. Deliberately eaten by assassin snails, loaches and pufferfish, which are the usual controls.",
    shellCalciumDemand: "Low to Medium",
    difficulty: 1,
    careSummary:
      "The classic hitchhiker 'pest' snail, almost always arriving uninvited on new plants. It is really a tireless detritivore that clears waste and dead leaves rather than eating healthy plants, and its numbers are a mirror of how much you overfeed. Harmless and genuinely useful, and if a population booms the fix is less food or an assassin snail, not chemicals that foul the tank.",
    imageSourceUrl: "https://commons.wikimedia.org/wiki/File:Physella_acuta_on_an_aquarium_plant.jpg",
    imageLicenseHint: "Commons (CC0)",
  },
];
