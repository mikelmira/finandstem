...
const TERMS: Term[] = [
  ...
  { term: "Ammonia (NH₃)", def: "The first and most toxic nitrogen waste from fish and rotting food. Should read zero in a cycled tank.", href: "/water-chemistry" },
  { term: "Biofilm", def: "The thin, natural layer of microbes and bacteria that coats surfaces in a tank. Food for shrimp and fry, and a sign of a maturing tank.", href: "/shrimp" },
  ...
  { term: "Blackwater", def: "Soft, acidic, tea-stained water created by tannins from wood and leaf litter, mimicking Amazon and Southeast Asian streams.", href: "/hardscape" },
  { term: "Bioload", def: "The total waste your livestock produces, which the biofilter and plants must process. Overstocking raises it past what the tank can handle.", href: "/planner" },
  { term: "Caridina", def: "A genus of shrimp, including crystal and bee shrimp, that wants soft, acidic, low-mineral water. Fussier than neocaridina.", href: "/shrimp" },
  { term: "Carpet plant", def: "A low, spreading plant grown to cover the foreground like a lawn, such as Monte Carlo or dwarf hairgrass.", href: "/plants" },
  { term: "CO₂ injection", def: "Adding carbon dioxide gas to the water so plants can photosynthesise faster. The biggest lever in a high-tech planted tank.", href: "/calculators/co2" },
  ...
  { term: "Drop checker", def: "A small glass indicator with a coloured solution that shows, by turning lime green, whether CO₂ is at a good level.", href: "/calculators/co2" },
  { term: "Dry start", def: "Growing carpet plants emersed (out of water) in a humid, shallow-filled tank before flooding it, to establish them faster.", href: "/aquascaping-design" },
  { term: "Emersed", def: "Grown with leaves above the waterline, in humid air rather than submerged. Many aquarium plants are farmed this way.", href: "/plants" },
  { term: "Epiphyte", def: "A plant like anubias or java fern that attaches to wood or rock rather than rooting in substrate. Its rhizome must stay uncovered.", href: "/plants" },
  ...
  { term: "Ich (white spot)", def: "A common parasite that appears as salt-like white spots on fish, usually after a chill or stress.", href: "/diseases" },
  ...
  { term: "Melt", def: "When a plant, often a crypt, sheds its leaves after being moved or after a parameter change, then regrows from the roots.", href: "/plants" },
  { term: "Molt", def: "How shrimp grow, shedding the old shell for a new one. Failed molts point to a general-hardness or mineral problem.", href: "/diseases" },
  { term: "Neocaridina", def: "A genus of hardy shrimp, including cherry shrimp, that tolerates a wide range of harder, neutral water. The beginner's shrimp.", href: "/shrimp" },
  { term: "Nitrate (NO₃⁻)", def: "The least toxic end of the nitrogen cycle, removed by water changes and taken up by plants. A stress and algae driver when high.", href: "/water-chemistry" },
  { term: "Nitrite (NO₂⁻)", def: "The toxic middle stage of the nitrogen cycle. Should read zero in a cycled tank.", href: "/water-chemistry" },
  ...
  { term: "PAR", def: "Photosynthetically active radiation, a measure of the usable light reaching your plants. It drives how demanding a plant you can grow.", href: "/equipment" },
  { term: "Photoperiod", def: "How long the lights are on each day. Too long or too bright for the plant mass invites algae.", href: "/algae" },
  ...
  { term: "Rhizome", def: "The horizontal stem of epiphytes like anubias and ferns, from which leaves and roots grow. It must not be buried.", href: "/plants" },
  ...
  { term: "Stem plant", def: "A fast-growing plant grown from cut stems, replanted and trimmed to shape. The backbone of Dutch and background planting.", href: "/plants" },
  ...
  { term: "Tannins", def: "Compounds leached by wood and leaves that tint water amber, soften it slightly and lower pH. Harmless and often desirable.", href: "/hardscape" },
  ...
  { term: "Walstad method", def: "A low-tech approach using soil and heavy planting to balance a tank with no CO₂ and minimal filtration.", href: "/aquascaping-design" },
  { term: "Water column", def: "The open water between substrate and surface, and where in it a fish or plant lives or feeds (top, middle, bottom).", href: "/planner" },
];
